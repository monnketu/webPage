...
const Results = (props) => {
  ...
  return(
    <div className={styles.results}>
      ...
      {Object.keys(props.data).map((data) => <ResultSpace ex1={props.data[data].coupon_name} ex2={props.data[data].coupon_isBattery} ex3={props.data[data].coupon_price} ex4={props.data[data].coupon_station} ex5={props.data[data].coupon_startTime} ex6={props.data[data].coupon_endTime}  ex7={props.data[data]['coupon_wi-fi']} ex8={props.data[data].coupon_address} ex9={txt8}/>)}
    </div>
  )
}
