...
const index = () => {
  return (
    <>
      ...
      <p className = "sentence">東京エリアコワーキングスペースのまとめサイトです。<br></br>口コミや投稿機能を使って、ユーザー同士でおすすめの場所を共有することができます。<br></br>リモートワーク、リモート授業が増える中、家だとなかなか集中できない…<br></br>移動中の空き時間にサクッと作業したい…<br></br>そんな悩みはありませんか？<br></br>フリースタイルを使えば、あなたにぴったりのコワーキングスペースを探せます。</p>
      <p className = "title">使い方</p>
      <p className = "subtitle">契約形態、日時から探す</p>
      <p className = "sentence">ワークスタイルに合ったワーキングスペースを探してみましょう。</p>
      ...
      <p className = "sentence">wi-fiや電源を使いたい<br></br>会議室を使いたい<br></br>プリンターやドリンクなど<br />オプションが充実している場所を使いたい<br></br>即日利用したい<br></br>そんな希望がある方は、自分が一番重視するワーキングスペースの特徴から検索してみましょう。</p>
